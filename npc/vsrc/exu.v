...
assign gpr_w_data = inst_type == `Inst_addi ? add_src1_imm : 
                    ...
                    inst_type == `Inst_lbu ? {{(`WordWidth-8){1'b0}}, mem_r_data[`WordWidth-1:`WordWidth-8]} : 
                    inst_type == `Inst_lhu ? {{(`WordWidth-16){1'b0}}, mem_r_data[`WordWidth-1:`WordWidth-16]} : 
                    inst_type == `Inst_lh ? {{(`WordWidth-16){mem_r_data[`WordWidth-1]}}, mem_r_data[`WordWidth-1:`WordWidth-16]} : 
