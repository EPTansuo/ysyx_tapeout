...
val map = Array(
	...
	ori     ->  List(PC_4  , A_RS1, B_IMM, ALU_OR    , IMM_I, WB_ALU, LD_XX , ST_XX, MASK_XX, BR_XX , INST_VALID  ),
	...
	sh      ->  List(PC_4  , A_RS1, B_IMM, ALU_ADD   , IMM_S, WB_XX , LD_XX , ST_SH, MASK_H , BR_XX , INST_VALID  ),
	sw      ->  List(PC_4  , A_RS1, B_IMM, ALU_ADD   , IMM_S, WB_XX , LD_XX , ST_SW, MASK_W , BR_XX , INST_VALID  ),
	lw      ->  List(PC_4  , A_RS1, B_IMM, ALU_ADD   , IMM_I, WB_MEM, LD_LW , ST_XX, MASK_XX, BR_XX , INST_VALID  ),
	...
	bltu    ->  List(PC_4  , A_PC , B_IMM, ALU_ADD   , IMM_B, WB_XX , LD_XX , ST_XX, MASK_XX, BR_LTU, INST_VALID  ),
	...
	srli    ->  List(PC_4  , A_RS1, B_IMM, ALU_SRL   , IMM_I, WB_ALU, LD_XX , ST_XX, MASK_XX, BR_XX , INST_VALID  ),
	srai    ->  List(PC_4  , A_RS1, B_IMM, ALU_SRA   , IMM_I, WB_ALU, LD_XX , ST_XX, MASK_XX, BR_XX , INST_VALID  ),
	srl     ->  List(PC_4  , A_RS1, B_RS2, ALU_SRL   , IMM_I, WB_ALU, LD_XX , ST_XX, MASK_XX, BR_XX , INST_VALID  ),
	sra     ->  List(PC_4  , A_RS1, B_RS2, ALU_SRA   , IMM_I, WB_ALU, LD_XX , ST_XX, MASK_XX, BR_XX , INST_VALID  ),
	slli    ->  List(PC_4  , A_RS1, B_IMM, ALU_SLL   , IMM_I, WB_ALU, LD_XX , ST_XX, MASK_XX, BR_XX , INST_VALID  ),
	sltu    ->  List(PC_4  , A_RS1, B_RS2, ALU_SLTU  , IMM_I, WB_ALU, LD_XX , ST_XX, MASK_XX, BR_XX , INST_VALID  ),
	...
	xor     ->  List(PC_4  , A_RS1, B_RS2, ALU_XOR   , IMM_I, WB_ALU, LD_XX , ST_XX, MASK_XX, BR_XX , INST_VALID  ),
	and     ->  List(PC_4  , A_RS1, B_RS2, ALU_AND   , IMM_I, WB_ALU, LD_XX , ST_XX, MASK_XX, BR_XX , INST_VALID  ),
	or      ->  List(PC_4  , A_RS1, B_RS2, ALU_OR    , IMM_I, WB_ALU, LD_XX , ST_XX, MASK_XX, BR_XX , INST_VALID  ),
)
val 
