...
val map = Array(
	...
	slt     ->  List(PC_4  , A_RS1, B_RS2, ALU_SLT   , IMM_I, WB_ALU, LD_XX , ST_XX, MASK_XX, BR_XX , CSR_XX, INST_VALID  ),
	sltu    ->  List(PC_4  , A_RS1, B_RS2, ALU_SLTU  , IMM_I, WB_ALU, LD_XX , ST_XX, MASK_XX, BR_XX , CSR_XX, INST_VALID  ),
	slti    ->  List(PC_4  , A_RS1, B_IMM, ALU_SLTU  , IMM_I, WB_ALU, LD_XX , ST_XX, MASK_XX, BR_XX , CSR_XX, INST_VALID  ),
