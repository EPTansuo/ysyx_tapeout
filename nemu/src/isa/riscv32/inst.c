...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  // //R-type 寄存器-寄存器操作指令
   ...
   INSTPAT("0000001 ????? ????? 111 ????? 01110 11", remuv  , R, R(rd) = SEXT((uint32_t)src1 % (uint32_t)(src2) ,32));
   ...
   INSTPAT("0000001 ????? ????? 100 ????? 01110 11", divw   , R, R(rd) = SEXT((int32_t)BITS(src1,31,0)/(int32_t)BITS(src2,31,0), 64));
   INSTPAT("0000001 ????? ????? 101 ????? 01110 11", divuw  , R, R(rd) = SEXT((uint32_t)BITS(src1,31,0)/(uint32_t)BITS(src2,31,0), 64));
