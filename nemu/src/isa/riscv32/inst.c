...
#define SHAMT (printf("SHAMT:%lld   ",(BITS(MUXDEF(CONFIG_USE_ICAHE, icache[index].inst, s->isa.inst.val), 24, 20))),\
printf("inst:%x\n", MUXDEF(CONFIG_USE_ICAHE, icache[index].inst, s->isa.inst.val)),\
